    ...
    <div className="relative transition-colors duration-300">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="aurora-background-wrapper absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="relative px-4 py-12 sm:px-6 sm:py-16 md:py-24 lg:py-32 lg:px-8">
